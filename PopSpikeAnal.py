...
pythondir="C:/Users/vlewitus/Documents/Python Scripts/ephys_anal"
os.chdir(pythondir)
...
if user=="VL":
	...
	outputdir="C:/Users/vlewitus/Documents/Python Scripts/Pickle//"
...
baseline_start=np.zeros((num_usable_traces), dtype=int)
...
meanpre=pretrace_amp[~np.isnan(pretrace_amp)].mean()
...
new_sample_times=np.int_(np.delete(sample_times,deletetime)+(baseline_minutes-sample_window/2))
...
validbasepts[baseline_minutes:]=False
...
if  np.abs(Bopt)-slope_std_factor*Bstd>0:
	...
	print( "**********************Baseline Seems to Be Fine********************: slope=", Bopt)
